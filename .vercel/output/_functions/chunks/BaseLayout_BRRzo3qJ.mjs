...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CsiTfVmY.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BWISU7m-.mjs').then(n => n._);
...
Construido con 🖤 y nostalgia digital
...
🎨 Tailwind
</a> </div> </div> </div> <!-- Signature retro ASCII art pequeño --> <div class="text-center py-4 border-t border-opacity-20" style="border-color: var(--theme-accent)" data-astro-cid-sz7xmlte> <pre class="text-xs opacity-50 font-mono leading-tight" data-astro-cid-sz7xmlte>░▒▓█ v0ュn∈0'ร bl0g █▓▒░
      </pre> </div> </div> </footer> `;
...
const $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="es" data-theme="vintage-parchment" data-astro-cid-losip7nv> <head><meta charset="UTF-8"><meta name="description"${addAttribute(description, "content")}><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>${title}</title><link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><text y='.9em' font-size='90'>🕳️</text></svg>">${renderHead()}</head> <body data-astro-cid-losip7nv> ${renderComponent($$result, "Header", $$Header, { "data-astro-cid-losip7nv": true })} <main class="content-container py-8" data-astro-cid-losip7nv> ${renderSlot($$result, $$slots["default"])} </main> ${renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-losip7nv": true })} ${renderScript($$result, "/home/vouneo/Dev/astro-blog/blog/src/components/BaseLayout.astro?astro&type=script&index=0&lang.ts")} </body> </html> `;
